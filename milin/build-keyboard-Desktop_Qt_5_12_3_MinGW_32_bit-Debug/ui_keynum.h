...
public:
    ...
    void setupUi(QWidget *Keynum)
    {
        if (Keynum->objectName().isEmpty())
            Keynum->setObjectName(QString::fromUtf8("Keynum"));
    ...
    {
        Keynum->setWindowTitle(QApplication::translate("Keynum", "Keynum", nullptr));
        pushButton->setText(QApplication::translate("Keynum", "PushButton", nullptr));
    } // retranslateUi
