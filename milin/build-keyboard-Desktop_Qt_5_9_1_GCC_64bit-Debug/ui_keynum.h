...
public:
    ...
    {
        Keynum->setWindowTitle(QApplication::translate("Keynum", "Keynum", Q_NULLPTR));
        pushButton->setText(QApplication::translate("Keynum", "PushButton", Q_NULLPTR));
    } // retranslateUi
